...
class SystemExecutor:
    ...
    def launch_application(self, app_name: str) -> str:
        ...
        target_key = "terminal" if "terminal" in app_name.lower() or "console" in app_name.lower() else "code"
            ...
            if self.current_os in os_app_map[target_key]:
                ...
                if self.current_os == "Windows" and target_key == "terminal":
                    ...
                    if self.current_os == "Linux":
                        ...
                        subprocess.Popen(commands, stdout=subprocess.DEVNULL, stderr=subprocess.DEVNULL)
    ...
    def get_system_load(self) -> str:
        ...
        try:
            ...
            return "I failed to draw metrics from the processor diagnostics pipeline, sir."