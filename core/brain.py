...
class AssistantBrain:
    def __init__(self):
        ...
        self.history = [
            {"role": "system", "content": f"You are {settings.ASSISTANT_NAME}, a highly efficient, crisp voice assistant. Keep answers brief, direct, and conversational."}
        ]
        print(f"[Brain Engine Module: Local Ollama Model ({self.model_name}) Connected]")

    def generate_response(self, user_input: str, complexity_tier: str, detected_lang: str) -> tuple[str, str]:
        ...
        if complexity_tier == "micro":
            ...
            print("[Brain Triage: Micro Input | Speed Mode Active (Strict Token Capping)]")
            ...
            print("[Brain Triage: Conversational Input | Standard Processing Mode Active]")
            ...
            print("[Brain Triage: Deep Context Input | High-Precision Analytical Mode Active]")
        ...
        try:
            ...
            return "I encountered a processing drop in my neural engine clusters, sir.", "en"